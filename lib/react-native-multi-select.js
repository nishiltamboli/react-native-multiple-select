...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    unselectedItemIcon: PropTypes.string,
    unselectedItemIconColor: PropTypes.string,
    ...
    afterClearSelector: PropTypes.func
  };
  ...
  _clearSelectorCallback = () => {
    const { afterClearSelector } = this.props;
    this._clearSelector();
    afterClearSelector && afterClearSelector();
  };
  ...
  _getRow = item => {
    const { selectedItemIconColor, displayKey, styleRowList, selectedItemIcon, unselectedItemIcon, unselectedItemIconColor } = this.props;
    return (
      <TouchableOpacity
              ...
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Icon
                      name={hideSubmitButton ? 'menu-right' : 'chevron-down'}
